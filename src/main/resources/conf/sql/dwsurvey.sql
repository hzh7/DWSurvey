...
CREATE TABLE `t_survey_answer` (
                                   ...
                                   `qu_answer_info` text DEFAULT NULL comment '答卷的题目与答案内容',
                                   PRIMARY KEY (`id`),
...
-- ----------------------------
BEGIN;
INSERT INTO `t_survey_answer` VALUES ('2a793ef9-28d9-4e99-afd5-a009c6356269', null, null, null, '2', null, '0', '2021-12-31 09:47:16', '0', '192.168.3.2', '1', '1', null, null, '58960016-ff92-4de7-9585-9ac27f961247', '0', '1', null);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_survey_directory` VALUES ('58960016-ff92-4de7-9585-9ac27f961247', '0', '1', '2021-12-31 09:46:57', '2', '0', null, '1', '', '4jfgcquk8', null, '1', '问卷题库', '2', '1', '1', '1', '0', '1', null, null, '/file/survey/4jfgcquk8/4jfgcquk8.json', '问卷题库');
COMMIT;
...
CREATE TABLE `t_report_directory` (
                                      ...
                                      `report_state` int(11) DEFAULT 0 COMMENT '报告状态：首次创建初始化0；例行更新1',
                                      `visibility` int(11) DEFAULT NULL,
                                      `survey_type` int(11) DEFAULT NULL,
                                      `preview_pdf_state` int DEFAULT 0 comment '预览报告状态',
                                      `min_sample_size` int DEFAULT 0 comment '生成报告的最小样本量',
                                      PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `t_report_question` (
                                     ...
                                     `qu_title`         text        null comment '原题目标题',
                                     `report_qu_title` text  null comment '报告中题目标题，如量表题的英文简写',
                                     PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
